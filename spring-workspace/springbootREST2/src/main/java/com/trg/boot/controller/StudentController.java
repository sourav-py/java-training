...
public class StudentController {
	...
	static {
		...
		data.put(101, new Student(101, "Abhishek", 75f, new Date(0)));
		data.put(102, new Student(102, "Birbal",75f,new Date(0)));
		data.put(103, new Student(103, "Charlie",75f,new Date(0)));
		data.put(104, new Student(104, "Deepak",75f,Date.valueOf("2000-01-01")));
